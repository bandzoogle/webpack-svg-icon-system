...
class SvgSprite {
    ...
    generate() {
        ...
        let x = 0;
        let y = 0; // eslint-disable-line no-unused-vars
        ...
        sortedKeys.forEach((iconPath) => {
            ...
            const { width, height } = svg.getDimensions(null, ICON_HEIGHT); // eslint-disable-line no-unused-vars
        ...
        //     ...<symbol />
        // </svg>
        const content = SvgDocument.create(...symbols);
